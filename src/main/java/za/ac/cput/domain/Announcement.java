...
public class Announcement {
    ...
    public static class Builder{
        ...
        public Builder theirAnnouncement_Id(int announcement_id) {
            this.announcement_id = announcement_id;
            return this;
        }

        public Builder theirAnnouncement_Date(String announcement_date) {
            this.announcement_date = announcement_date;
            return this;
        }

        public Builder theirAnnouncement_Content(String announcement_content) {
